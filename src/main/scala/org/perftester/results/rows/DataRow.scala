...
case class GCDataRow(startNs: Long, endNs: Long, startMs: Long, endMs: Long, name: String, action: String, cause: String, threads: Int) extends DataRow {
...
case class PhaseRow(override val rowType: DataRowType,
                    startNs: Long, endNs: Long, runId: Int, phaseId: Int, phaseName: String, purpose: String, threadId: Int, threadName: String,
                    runNs: Long, idleNs: Long, cpuTimeNs: Long, userTimeNs: Long, allocatedBytes: Long, heapSize: Long) extends DataRow {
