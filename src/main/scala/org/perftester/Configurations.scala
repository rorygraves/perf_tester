...
object Configurations {
  ...
  val configurations: Map[String, List[TestConfig]] = Map(
    ...
    "mikeLatest" -> List(
      ...
      //            "-Yprofile-run-gc", "all")
      //          ),
      TestConfig(s"00_backend-2-3-0", BuildFromGit("ac484f21675179f303177e00ba76fe8dbb41c9e9"), extraArgs = List(
        "-YaddBackendThreads", "2",
        "-YIoWriterThreads", "3",
        "-YosIoThreads", "0",
        "-Yprofile-run-gc", "all")
      ),
      TestConfig(s"00_backend-1-0-0", BuildFromGit("ac484f21675179f303177e00ba76fe8dbb41c9e9"), extraArgs = List(
        "-YaddBackendThreads", "1",
        "-YIoWriterThreads", "0",
        "-YosIoThreads", "0",
        "-Yprofile-run-gc", "all")
      ),
      TestConfig(s"00_backend-0-0-0", BuildFromGit("ac484f21675179f303177e00ba76fe8dbb41c9e9"), extraArgs = List(
        "-YaddBackendThreads", "0",
        "-YIoWriterThreads", "0",
        "-YosIoThreads", "0",
        "-Yprofile-run-gc", "all")
